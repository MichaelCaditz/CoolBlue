...
BEGIN
   ...
   DECRYPTION BY CERTIFICATE CCPINS; 
	...
	--a.cNameFirst,a.cNameLast,
	 ...
	 SELECT a.ID,a.dtCreateDate,a.nAccountTypeID,a.cName as cShortName,replace(left(a.cNote,160),CHAR(13)+CHAR(10),' ') as cNote,a.cDesc,a.nCurrencyID,a.nCatID,b.cName as currencyName,b.cSymbol as currencySymbol,
