...
FROM            dbo.clients AS a INNER JOIN
                         ...
                         dbo.clientMasterMailGroup AS c ON a.clients_id = c.nClientMasterID
WHERE        (b.nContactGroupID IN (1022)) AND (b.nContactGroupID NOT IN (1017, 1033, 1050, 1051, 1120, 1147)) AND (c.nMailGroupID IN (1000))
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'NYMailList';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'NYMailList';
